...
import { ListIcon, CalendarIcon, TrophyIcon } from './icons';
...
const navItems = [
  { view: 'goals' as ViewType, label: '목표', icon: ListIcon },
  { view: 'calendar' as ViewType, label: '캘린더', icon: CalendarIcon },
  { view: 'achievements' as ViewType, label: '달성', icon: TrophyIcon },
];
