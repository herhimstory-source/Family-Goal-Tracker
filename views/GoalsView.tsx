...
import { isToday, isThisWeek, isThisMonth, isCompletedToday } from '../utils/dateUtils';
...
type FilterType = 'today' | 'completedToday' | 'week' | 'month';
...
const GoalsView: React.FC<GoalsViewProps> = ({ goals, onEdit, onDelete, onToggleComplete }) => {
